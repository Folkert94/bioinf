...
# This script classifies proteins according to the SCOP database provided
# in this project. The proteins are classified as similar if they are in the
# same family or superfamily.
